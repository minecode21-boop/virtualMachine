...
declare -A OS_OPTIONS=(
    ...
    ["Ubuntu 24.04"]="ubuntu|noble|https://vscode.dev/github/jishnudiscord14-droid/vps123/blob/main/disk.raw|ubuntu24|ubuntu|ubuntu"
    ...
    ["AlmaLinux 9"]="almalinux|9|https://www.suse.com/download/sles/#|almalinux9|alma|alma"
