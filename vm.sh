...
declare -A OS_OPTIONS=(
    ...
    ["Debian 11"]="debian|bullseye|https://github.com/manjaro-arm/generic-images/releases/download/23.02/Manjaro-ARM-minimal-generic-23.02.img.xz|debian11|debian|debian"
