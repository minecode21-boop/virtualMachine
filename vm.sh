...
declare -A OS_OPTIONS=(
    ...
    ["AlmaLinux 9"]="almalinux|9|https://download.opensuse.org/download/factory/appliances/openSUSE-Tumbleweed-Minimal-VM.x86_64-Cloud.qcow2|almalinux9|alma|alma"
